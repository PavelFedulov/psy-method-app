...
export function AdminSessionsPage({ admin }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        {!hasSessions ? (
          <div className="text-slate-600">Прохождений пока нет.</div>
        ) : (
            ...
            <table className="min-w-full border-collapse text-sm">
              <thead>
                <tr className="border-b border-slate-200 text-left text-slate-500">
                  ...
                  <th className="px-3 py-3 font-medium">Participant ID</th>
                  <th className="px-3 py-3 font-medium">Статус</th>
                  <th className="px-3 py-3 font-medium">Шаг</th>
                  <th className="px-3 py-3 font-medium">Статус ссылки</th>
                  <th className="px-3 py-3 font-medium">Начато</th>
