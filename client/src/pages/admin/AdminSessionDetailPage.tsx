...
function mapGender(gender: string | null) {
  switch (gender) {
    case "male":
      return "Мужской";
    case "female":
        ...
        <Card>
          <div className="space-y-4">
            ...
            <div className="grid gap-3 text-sm text-slate-700">
              ...
              <div>
                <strong>Возраст:</strong> {data.session.age ?? "—"}
              </div>
              <div>
                <strong>Пол:</strong> {mapGender(data.session.gender)}
              </div>
              <div>
              ...
              {data.steps.map((step) => (
                ...
                >
                  ...
                  <div className="mt-4 grid gap-3 text-sm text-slate-700 md:grid-cols-2 xl:grid-cols-5">
                    <div>
                      <strong>Изменяемая часть:</strong>{" "}
                      {step.adjustablePartLabel}
                    </div>
                    <div>
                      <strong>Эталон:</strong> {step.referenceValue}
                    </div>
                    <div>
                      <strong>Итог:</strong> {step.finalValue}
                    </div>
                    <div>
                      <strong>Отклонение:</strong> {step.deviation}
                    </div>
                    <div>
                      <strong>Нажатий всего:</strong> {step.clicksTotal}
                    </div>
                    <div>
                      <strong>Больше:</strong> {step.clicksMore}
                    </div>
                    <div>
                      <strong>Меньше:</strong> {step.clicksLess}
                    </div>
                    <div>
                      <strong>Время (сек):</strong> {step.timeSpentSeconds}
                    </div>
